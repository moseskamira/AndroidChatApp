...
class MainPageAdapter(private val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.chat_item_view,
            parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.chatTitle.text = chatList[position].chatId
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val chatTitle: TextView = itemView.chat_title
